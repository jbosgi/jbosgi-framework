...
*/
package org.jboss.test.osgi.container.jbosgi323;
   ...
   public void testStaticImport() throws Exception
   {
      ...
      archiveA.setManifest(new Asset()
      {
         public InputStream openStream()
         {
            ...
            builder.addImportPackages("org.jboss.test.osgi.container.classloader.support.a");
      ...
      archiveB.setManifest(new Asset()
      {
         public InputStream openStream()
         {
            ...
            builder.addExportPackages("org.jboss.test.osgi.container.classloader.support.a");
            builder.addExportPackages("org.jboss.test.osgi.container.classloader.support.b");
            return builder.openStream();
         }
      });
   ...
   public void testDynamicImportWithPackage() throws Exception
   {
      ...
      archiveA.setManifest(new Asset()
      {
         public InputStream openStream()
         {
            ...
            builder.addBundleManifestVersion(2);
            builder.addBundleSymbolicName(archiveA.getName());
            builder.addDynamicImportPackages("org.jboss.test.osgi.container.classloader.support.a");
            return builder.openStream();
         }
      });
