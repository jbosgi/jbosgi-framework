 ...
 * 
 * Every time a fragment is updated a new {@link FragmentRevision} is created and referenced from the {@link FragmentBundle}.
 * 
...
public class FragmentRevision extends AbstractUserRevision {
    ...
    public FragmentRevision(AbstractUserBundle bundleState, Deployment dep) throws BundleException {
