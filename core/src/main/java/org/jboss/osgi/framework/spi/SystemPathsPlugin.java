...
public interface SystemPathsPlugin extends Service<SystemPathsPlugin> {
    ...
    String[] DEFAULT_FRAMEWORK_PACKAGES = new String[]{
            ...
            "org.jboss.osgi.deployment.deployer;version=1.1",
            "org.jboss.osgi.deployment.interceptor;version=1.1",
            "org.jboss.osgi.framework;version=2.0",
            "org.jboss.osgi.metadata;version=2.1",
        	"org.jboss.osgi.resolver;version=3.0",
        	"org.jboss.osgi.resolver.spi;version=3.0",
            "org.jboss.osgi.spi;version=3.1",
            "org.jboss.osgi.vfs;version=1.1",
