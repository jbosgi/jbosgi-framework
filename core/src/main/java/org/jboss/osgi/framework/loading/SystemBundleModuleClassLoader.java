...
/**
 * The {@link ModuleClassLoader} for the system bundle.
 * 
...
public class SystemBundleModuleClassLoader extends AbstractModuleClassLoader {
    ...
    private SystemBundleModuleClassLoader(SystemBundle bundleState, Configuration configuration) {
    ...
    public static class Factory implements ModuleClassLoaderFactory {
        ...
        public Factory(SystemBundle bundleState) {
            this.bundleState = bundleState;
        }

        @Override
        public ModuleClassLoader create(Configuration configuration) {
            return new SystemBundleModuleClassLoader(bundleState, configuration);
        }
    }
}
